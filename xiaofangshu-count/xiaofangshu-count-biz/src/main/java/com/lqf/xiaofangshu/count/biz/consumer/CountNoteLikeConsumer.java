...
import com.lqf.xiaofangshu.count.biz.enums.LikeUnlikeNoteTypeEnum;
import com.lqf.xiaofangshu.count.biz.model.dto.AggregationCountLikeUnlikeNoteMqDTO;
import com.lqf.xiaofangshu.count.biz.model.dto.CountLikeUnlikeNoteMqDTO;
...
public class CountNoteLikeConsumer implements RocketMQListener<String> {
    ...
    private void consumeMessage(List<String> bodys) {
        ...
        List<CountLikeUnlikeNoteMqDTO> countLikeUnlikeNoteMqDTOS = bodys.stream()
                .map(b -> JsonUtils.parseObject(b, CountLikeUnlikeNoteMqDTO.class)).toList();
        ...
        countList.forEach(item -> {
            ...
            boolean isCountNoteExisted = Boolean.TRUE.equals(redisTemplate.hasKey(countNoteRedisKey));
            ...
            boolean isCountUserExisted = Boolean.TRUE.equals(redisTemplate.hasKey(countUserRedisKey));
