...
import com.lqf.xiaofangshu.oss.biz.config.MinioProperties;
import com.lqf.xiaofangshu.oss.biz.enums.ResponseCodeEnum;
...
public class MinioFileStrategy implements FileStrategy {
    ...
    public String uploadFile(MultipartFile file, String bucketName) {
        ...
        if (file == null || file.getSize() == 0) {
            ...
            throw new BizException(ResponseCodeEnum.EMPTY_FILE);
        }
