package com.lqf.xiaofangshu.data.align.job;
...
import com.lqf.xiaofangshu.data.align.domain.mapper.DeleteMapper;
import com.lqf.xiaofangshu.data.align.domain.mapper.SelectMapper;
import com.lqf.xiaofangshu.data.align.domain.mapper.UpdateMapper;
import com.lqf.xiaofangshu.data.align.rpc.SearchRpcService;
        ...
        for (;;) {
            ...
            noteIds.forEach(noteId -> {
                ...
                if (count > 0) {
                    ...
                    // 判断 Hash 是否存在
                    boolean hashKey = Boolean.TRUE.equals(redisTemplate.hasKey(redisKey));
                    // 若存在
                    if (hashKey) {
