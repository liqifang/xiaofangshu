package com.lqf.xiaofangshu.data.align.consumer;

import com.lqf.framework.common.util.JsonUtils;
import com.lqf.xiaofangshu.data.align.constant.MQConstants;
import com.lqf.xiaofangshu.data.align.constant.RedisKeyConstants;
import com.lqf.xiaofangshu.data.align.constant.TableConstants;
import com.lqf.xiaofangshu.data.align.domain.mapper.InsertMapper;
import com.lqf.xiaofangshu.data.align.model.dto.FollowUnfollowMqDTO;
...
public class TodayUserFollowIncrementData2DBConsumer implements RocketMQListener<String> {
    ...
    public void onMessage(String body) {
        ...
        if (Objects.equals(result, 0L)) {
            ...
            // bloom:user:follow:20250730
        }

        // ------------------------- 目标用户的粉丝数变更记录 -------------------------
        // 目标用户 ID 对应的 Bloom Key
        String targetUserBloomKey = RedisKeyConstants.buildBloomUserFansListKey(date); // bloom:user:fans:20250730
        // 布隆过滤器判断该日增量数据是否已经记录
