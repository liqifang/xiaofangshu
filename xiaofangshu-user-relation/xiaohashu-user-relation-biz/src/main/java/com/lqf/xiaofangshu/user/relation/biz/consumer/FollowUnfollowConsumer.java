package com.lqf.xiaofangshu.user.relation.biz.consumer;
...
public class FollowUnfollowConsumer implements RocketMQListener<Message> {
    ...
    private void handleUnfollowTagMessage(String bodyJsonStr) {
        ...
        if (isSuccess) {
            redisTemplate.opsForZSet().remove(RedisKeyConstants.buildUserFansKey(unfollowUserId), userId);
