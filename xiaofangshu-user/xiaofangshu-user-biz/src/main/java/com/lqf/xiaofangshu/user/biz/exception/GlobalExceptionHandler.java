package com.lqf.xiaofangshu.user.biz.exception;
...
public class GlobalExceptionHandler {
    ...
    @ResponseBody
    public Response<Object> handleControllerException(HttpServletRequest request, MethodArgumentNotValidException e) {
        // 参数错误异常码
